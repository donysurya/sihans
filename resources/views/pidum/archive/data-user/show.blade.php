...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-user-clock me-2"></i>Data Pengunjung</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-end">
                                <a class="btn bg-gradient-danger mb-0" href="{{ route('pidum.archive.user') }}"><i class="fas fa-chevron-left"></i>&nbsp;&nbsp;Kembali</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="alert alert-warning text-white" role="alert">
                                                <i class="fas fa-exclamation-circle me-2"></i><strong>Informasi!</strong> Masa berlaku akun telah berakhir!
                                            </div>
                                        </div>
                                        <div class="col-md-12">
