...
@section('title', 'Arsip Data Pengunjung | Petugas Pidum')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Arsip Data Pengunjung</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-user-clock me-2"></i>Arsip Data Pengunjung</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header pt-3">
                        <div class="row mb-3 align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Daftar Arsip Pengunjung</h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="card px-0">
                                    ...
                                    <form method="get" action="">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="{{ route('pidum.archive.user') }}" class="btn btn-success btn-sm ms-auto"><i class="fa fa-th me-2"></i>Tampilkan Semua</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($user as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-restore-tahanan{{ $item->id }}"><i class="fas fa-trash-restore me-2"></i>Restore</a><br>
                                                            <a class="btn btn-link text-primary px-2 mb-0" href="{{ route('pidum.archive.user.show', ['id' => $item->id]) }}"><i class="fas fa-eye text-primary me-2" aria-hidden="true"></i>Lihat</a>
                                                        </td>

                                                        <!-- Restore Modal -->
                                                        <div class="modal fade" id="modal-restore-tahanan{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-restore-tahanan{{ $item->id }}" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <div class="py-3 text-center">
                                                                            ...
                                                                            <p>Apakah anda yakin ingin mengembalikan Data Pengunjung?</p>
                                                                        </div>
                                                                        <div class="text-center">
                                                                            <form action="{{ route('pidum.archive.user.restore', ['id' => $item->id]) }}" method="get">
                                                                                @csrf
                                                                                <button type="submit" class="btn btn-primary"><i class="fas fa-trash-restore me-2"></i>Restore Data</button>
                                                                            </form>
