...
@section('title', 'Arsip Data Kunjungan | Petugas Pidum')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Arsip Data Kunjungan</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-person-booth me-2"></i>Arsip Data Kunjungan</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header pt-3">
                        <div class="row mb-3 align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Arsip Daftar Kunjungan</h6>
                            </div>
                        </div>
                        <div class="row">
                            <div class="card px-0">
                                            ...
                                            <tbody>
                                                @forelse($besuk as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <a class="btn btn-link text-primary px-2 mb-0" href="{{ route('pidum.archive.besuk.show', ['id' => $item->id]) }}"><i class="fas fa-eye text-primary me-2" aria-hidden="true"></i>Lihat</a>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
